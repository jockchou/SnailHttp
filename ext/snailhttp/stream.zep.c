...
PHP_METHOD(SnailHttp_Stream, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&meta, "stream_get_meta_data", NULL, 16, _0);
...
PHP_METHOD(SnailHttp_Stream, __toString) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "stream_get_contents", NULL, 17, _1);
	zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Stream, getSize) {
	...
	if (zephir_is_true(_2)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "clearstatcache", NULL, 18, ZEPHIR_GLOBAL(global_true), _3$$5);
		zephir_check_call_status();
	}
	_4 = zephir_fetch_nproperty_this(this_ptr, SL("stream"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&stats, "fstat", NULL, 19, _4);
	zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Stream, tell) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("stream"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&result, "ftell", NULL, 20, _0);
	zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Stream, seek) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, whence);
	ZEPHIR_CALL_FUNCTION(&_4, "fseek", NULL, 21, _1, &_2, &_3);
	zephir_check_call_status();
	if (!(zephir_is_true(_0))) {
		...
		ZEPHIR_CALL_FUNCTION(&_9$$4, "sprintf", NULL, 22, &_6$$4, &_7$$4, &_8$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _5$$4, "__construct", NULL, 23, _9$$4);
		zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Stream, read) {
	...
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_LONG(&_2, length);
	ZEPHIR_CALL_FUNCTION(&result, "fread", NULL, 24, _1, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(result)) {
...
PHP_METHOD(SnailHttp_Stream, getContents) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("stream"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&contents, "stream_get_contents", NULL, 17, _0);
	zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Stream, getMetadata) {
	...
	_2 = zephir_fetch_nproperty_this(this_ptr, SL("stream"), PH_NOISY_CC);
	ZEPHIR_CALL_FUNCTION(&meta, "stream_get_meta_data", NULL, 16, _2);
	zephir_check_call_status();
	if (!(zephir_is_true(key))) {
		RETURN_CCTOR(meta);
	} else {
