...
PHP_METHOD(SnailHttp_Headers, createFromGlobals) {
	...
	ZEPHIR_CALL_METHOD(NULL, env, "__construct", NULL, 2, globals);
...
PHP_METHOD(SnailHttp_Headers, all) {
	...
	ZEPHIR_INIT_VAR(out);
	array_init(out);
	ZEPHIR_CALL_PARENT(&all, snailhttp_headers_ce, this_ptr, "all", &_0, 3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_1);
...
PHP_METHOD(SnailHttp_Headers, set) {
	...
	ZEPHIR_CALL_PARENT(NULL, snailhttp_headers_ce, this_ptr, "set", &_0, 4, _1, _2);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(SnailHttp_Headers, get) {
	...
	if (zephir_is_true(_0)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_PARENT(&_1$$3, snailhttp_headers_ce, this_ptr, "get", &_2, 5, _3$$3);
		zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Headers, add) {
	...
	ZEPHIR_INIT_VAR(_1);
	ZEPHIR_CALL_FUNCTION(&_2, "array_values", NULL, 6, newValues);
	zephir_check_call_status();
...
PHP_METHOD(SnailHttp_Headers, has) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "normalizekey", NULL, 0, key);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_PARENT(snailhttp_headers_ce, this_ptr, "has", &_0, 7, _1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(SnailHttp_Headers, remove) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "normalizekey", NULL, 0, key);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, snailhttp_headers_ce, this_ptr, "remove", &_0, 8, _1);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(SnailHttp_Headers, normalizeKey) {
	...
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_STRING(&_2, "-", 0);
	ZEPHIR_CALL_FUNCTION(&_3, "strtr", NULL, 9, key, &_1, &_2);
	zephir_check_call_status();
